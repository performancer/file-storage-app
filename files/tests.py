...
class TestFileUpload(APITestCase):
    def setUp(self):
        ...
        # populate users
        self.user = User.objects.create_user(username='user_with_org', password='password123', organization=self.organization)
...
class TestFileListDownloads(APITestCase):
    def setUp(self):
        ...
        # populate users
        self.user = User.objects.create_user(username='user', password='password123', organization=organization)
